...
<div class="experience-section">
  ...
  <div class="experience-entry">
    <h2 class="position-title">Research Scientist at ADIA (Abu Dhabi Investment Authority) Lab</h2>
    
    <div class="position-metadata">
      <div class="date-range">
        <i class="fas fa-calendar-alt"></i> December 2025 - present
      </div>
    ...
    <div class="supervisor">
      Supervisor: <a href="https://ae.linkedin.com/in/skhanshadab" target="_blank">Dr. Shadab Khan</a>
    </div>
    
    <div class="position-description">
      I am majorly working on agent reasoning and planning in sandbox environment setups.
    </div>
    
    <a href="https://www.adialab.ae/" target="_blank">
      <img src="{{site.url}}{{site.baseurl}}/images/experience/adialab.png" alt="ADIA Lab Logo" class="institution-logo">
    </a>
    <a href="https://www.adia.ae/" target="_blank">
      <img src="{{site.url}}{{site.baseurl}}/images/experience/adia_logo.png" alt="ADIA Logo" class="institution-logo">
    </a>
  </div>
...
<div class="experience-section">
  ...
  <div class="experience-entry">
    ...
    <div class="position-metadata">
      <div class="date-range">
        <i class="fas fa-calendar-alt"></i> September 2024 - December 2025
      </div>
